...
var color = d3.scaleOrdinal()
					...
					.domain(["Hans Rosling", "Juan Enriquez", "Rives", "Marco Tempest",
							 "Clay Shirky"]);
...
var rScale = d3.scaleSqrt()
			.range([mobileScreen ? 3 : 5, mobileScreen ? 10 : 27])
...
var voronoi = d3.voronoi()
	.x(function(d) { return xScale(d.published_year); })
...
var circlesOuter = circleClipGroup.selectAll(".circle-wrapper")
	...
	.attr("cx", function(d) {return xScale(d.published_year);})
...
function removeTooltip (d, i) {
	...
	var element = d3.select(".countries."+d.CountryCode).transition().duration(200);
...
function showTooltip (d, i) {
	...
	$(el).popover({
		...
		content: function() { 
			...
			+ "<span>" + "Duration: " + "</span>" + Math.round(d.Duration) + "min" + "\n" +"</span>";}
	});
	$(el).popover('show');
